...
public class ParentMediaNodeInfoView extends LinearLayout{
	...
	public ParentMediaNodeInfoView(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		shiftButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				if(mediaNodeSelector!=null){
					mediaNodeSelector.shiftNodeUp(mediaNode);
				}
			}
		});
	}
	...
	public void refresh(){
		...
		shiftButton.setVisibility((mediaNode.getParent()!=null ? VISIBLE : INVISIBLE));
